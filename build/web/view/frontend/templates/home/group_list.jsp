        ...
        <div class="container">
            <div class="col-full">
                <div class="forum-list">
                    ...
                    <h2 class="list-title">
                        <a href="javascript:">Nhóm bạn theo dõi</a>
                    </h2>
                    <c:if test="${groups_non_admin.size() <= 0 || groups_non_admin == null}">
                        <div style="text-align: center; height: 40px;"><p>Bạn chưa theo dõi nhóm môn học nào</p></div>
                    </c:if>
                    <c:if test="${groups_non_admin.size() > 0}">
                        <c:forEach var="entry" items="${groups_non_admin}">
                ...
                <div class="forum-list">
                    <h2 class="list-title">
                        <a href="javascript:">Nhóm bạn làm quản trị viên</a>
                    </h2>
                    <c:if test="${groups_admin.size() <= 0 || groups_admin == null}">
                        <div style="text-align: center; height: 40px;"><p>Không có nhóm nào</p></div>
                    </c:if>
                    <c:forEach var="entry" items="${groups_admin}">
                        <div class="forum-listing">
                            <div class="forum-details">
                                <a class="text-xlarge" href="<%= request.getContextPath()%>/groups/${entry.id}">${entry.name}</a>
                                <p>${entry.description}</p>
