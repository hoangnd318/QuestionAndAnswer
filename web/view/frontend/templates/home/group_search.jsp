        ...
        <div class="container">
            ...
            <div class="col-full">
                <div class="forum-list">
                    ...
                    <h2 class="list-title">
                        <a href="javascript:void(0)">Danh sách nhóm môn học</a>
                    </h2>
                    <c:if test="${groups.size() <= 0 || groups == null}">
                        <div style="text-align: center; height: 40px;"><p>Không tìm thấy nhóm nào</p></div>
                    </c:if>
