                                        ...
                                        <div class="col col12">
                                            <div class="wrap-tabs">
                                                <div class="menu-tabs active-menu">
                                                    <ul class="menu flex">
                                                        <li class="<c:if test="${type_sort == 'moi-nhat'}">active-tab</c:if>"><a href="<%= request.getContextPath() + "/qanda?sort=moi-nhat"%>">Mới nhất</a></li>
                                                        <li class="<c:if test="${type_sort == 'cu-nhat'}">active-tab</c:if>"><a href="<%= request.getContextPath() + "/qanda?sort=cu-nhat"%>">Cũ nhất</a></li>
                                                        <li class="<c:if test="${type_sort == 'noi-bat'}">active-tab</c:if>"><a href="<%= request.getContextPath() + "/qanda?sort=noi-bat"%>">Nổi bật</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="question-inner">
                                                            <div class="question-image-vote">
                                                                <div class="author-image">
                                                                    <a href="<%= request.getContextPath()%>/qanda/user/profile/question/${entry.author.idUser}">
                                                            ...
                                                            <div class="question-content">
                                                                <header class="article-header">
                                                                    <div class="question-header">
                                                                        <a class="post-author" href="<%= request.getContextPath()%>/qanda/user/profile/question/${entry.author.idUser}">${entry.author.firstname} ${entry.author.lastname}</a>
                                                                        <div class="post-meta">
                                                    ...
                                                    <c:if test="${page_total > 1}">    
                                                        <c:if test="${questions.size() > 0}">
                                                            <c:if test="${page_current != 1}">
                                                                <a class="prev page-numbers" href="<%= request.getContextPath()%>/qanda?sort=${type_sort}&page=${page_current-1}">
                                                            ...
                                                            <c:if test="${page_total <= 5}">
                                                                <c:forEach var="i" begin="1" end="${page_total}">
                                                                    <c:if test="${i != page_current}">
                                                                        <a class="page-numbers" href="<%= request.getContextPath()%>/qanda?sort=${type_sort}&page=${i}">${i}</a>
                                                                    </c:if>
                                                                    <c:if test="${i == page_current}">
                                                            ...
                                                            <c:if test="${page_total > 5}">
                                                                <c:if test="${page_current <= 3}">
                                                                    ...
                                                                    <a class="page-numbers" href="<%= request.getContextPath()%>/qanda?sort=${type_sort}&page=${page_total}">${page_total}</a>
                                                                </c:if>
                                                                <c:if test="${page_current > 3}">  
                                                                    <c:if test="${page_current >= (page_total - 3)}">
                                                                        <a class="page-numbers" href="<%= request.getContextPath()%>/qanda?sort=${type_sort}&page=1">1</a>
                                                                        <span class="page-numbers dots">…</span>
                                                            ...
                                                            <c:if test="${page_current != page_total}">
                                                                <a class="next page-numbers" href="<%= request.getContextPath()%>/qanda?sort=${type_sort}&page=${page_current+1}">
        ...
        <script>
            ...
            $('.notifications-list').on('scroll', function () {
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) {
                    ...
                    $.ajax({
                        url: "<%=request.getContextPath()%>/qanda/getNotifyNext",
                        type: 'post',
                        dataType: 'text',
                        data: {
                            n_id: $('.notifications-list li:last-child')[0].id,
                            page: page
                        },
